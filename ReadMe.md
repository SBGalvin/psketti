...
tell you which ones to install.
...
Characteristic Curves (ICC), and set the minimum and maximum x axis
...
```
    ...
    ## 5                          2 -0.04 0.76 0.07 0.06 0.05 0.06
    ## 6                          3  2.16 0.98 0.01 0.01 0.00 0.00
    ## 7   i03  -0.5              1 -2.16 0.16 0.23 0.21 0.23 0.17
    ## 8                          2 -0.04 0.61 0.10 0.09 0.10 0.10
    ## 9                          3  2.16 0.92 0.03 0.02 0.02 0.02
    ## 10  i04 -0.18              1 -2.16 0.15 0.22 0.20 0.23 0.20
    ## 11                         2 -0.04 0.53 0.12 0.13 0.09 0.13
    ## 12                         3  2.16 0.91 0.03 0.02 0.02 0.02
    ## 13  i05  -1.8              1 -2.16 0.42 0.11 0.13 0.17 0.17
    ## 14                         2 -0.04 0.85 0.03 0.03 0.04 0.05
    ## 15                         3  2.16 0.98 0.01 0.01 0.01 0.01
    ## 16  i06  1.12              1 -2.16 0.03 0.28 0.27 0.21 0.21
    ## 17                         2 -0.04 0.24 0.18 0.18 0.20 0.19
    ## 18                         3  2.16 0.76 0.06 0.07 0.06 0.05
    ## 19  i07 -0.47              1 -2.16 0.14 0.22 0.19 0.27 0.17
    ## 20                         2 -0.04 0.60 0.10 0.09 0.09 0.11
    ## 21                         3  2.16 0.95 0.01 0.02 0.01 0.02
    ## 22  i08  0.04              1 -2.16 0.09 0.24 0.22 0.21 0.24
    ## 23                         2 -0.04 0.50 0.13 0.13 0.12 0.13
    ## 24                         3  2.16 0.83 0.01 0.05 0.03 0.07
    ## 25  i09  0.39              1 -2.16 0.10 0.26 0.20 0.24 0.19
    ## 26                         2 -0.04 0.39 0.16 0.15 0.15 0.15
    ...
    ## 31  i11 -0.26              1 -2.16 0.20 0.22 0.17 0.17 0.24
    ## 32                         2 -0.04 0.54 0.10 0.11 0.14 0.10
    ## 33                         3  2.16 0.89 0.03 0.03 0.02 0.02
    ## 34  i12 -1.24              1 -2.16 0.34 0.15 0.15 0.17 0.19
    ## 35                         2 -0.04 0.75 0.06 0.07 0.06 0.07
    ## 36                         3  2.16 0.96 0.02 0.01 0.01 0.00
    ## 37  i13  2.32              1 -2.16 0.01 0.28 0.24 0.24 0.24
    ## 38                         2 -0.04 0.09 0.23 0.21 0.23 0.23
    ## 39                         3  2.16 0.46 0.12 0.16 0.19 0.07
    ...
    ## 44                         2 -0.04 0.37 0.15 0.16 0.17 0.15
    ## 45                         3  2.16 0.78 0.07 0.05 0.06 0.04
    ## 46  i16 -0.95              1 -2.16 0.22 0.20 0.16 0.22 0.20
    ## 47                         2 -0.04 0.71 0.08 0.09 0.07 0.06
    ## 48                         3  2.16 0.93 0.01 0.03 0.02 0.01
    ## 49  i17  0.38              1 -2.16 0.06 0.22 0.28 0.24 0.20
    ## 50                         2 -0.04 0.41 0.15 0.13 0.16 0.15
    ## 51                         3  2.16 0.85 0.03 0.04 0.03 0.06
    ## 52  i18  0.55              1 -2.16 0.08 0.25 0.24 0.23 0.20
    ## 53                         2 -0.04 0.36 0.16 0.17 0.14 0.17
    ## 54                         3  2.16 0.83 0.06 0.03 0.04 0.03
    ## 55  i19 -0.06              1 -2.16 0.17 0.19 0.23 0.18 0.22
    ## 56                         2 -0.04 0.50 0.10 0.15 0.11 0.14
    ## 57                         3  2.16 0.88 0.04 0.02 0.01 0.04
    ## 58  i20  0.45              1 -2.16 0.12 0.25 0.21 0.26 0.16
    ## 59                         2 -0.04 0.38 0.15 0.14 0.17 0.17
    ## 60                         3  2.16 0.83 0.05 0.04 0.04 0.03
    ## 61  i21  0.75              1 -2.16 0.06 0.26 0.20 0.25 0.23
    ## 62                         2 -0.04 0.33 0.18 0.16 0.16 0.17
    ## 63                         3  2.16 0.76 0.06 0.06 0.06 0.06
    ## 64  i22 -0.83              1 -2.16 0.21 0.19 0.20 0.20 0.20
    ## 65                         2 -0.04 0.68 0.08 0.08 0.07 0.09
